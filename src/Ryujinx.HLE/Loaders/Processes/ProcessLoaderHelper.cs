...
namespace Ryujinx.HLE.Loaders.Processes
{
    static class ProcessLoaderHelper
    {
            ...
            params ReadOnlySpan<IExecutable> executables)
        {
            ...
            Logger.Warning?.Print(LogClass.Loader, $"[Nextendo] NPDM meta.Flags=0x{meta.Flags:X2} (bit0/Is64Bit={(meta.Flags & 1)}, addrSpace={((meta.Flags >> 1) & 7)}) execCount={executables.Length}");
