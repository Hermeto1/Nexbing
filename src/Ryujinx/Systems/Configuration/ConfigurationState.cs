...
namespace Ryujinx.Ava.Systems.Configuration
{
    public partial class ConfigurationState
    {
        ...
        public void LoadDefault()
        {
            ...
            System.EnableInternetAccess.Value = true; // [Nextendo] online activé d'office (guest internet access coché par défaut)
            ...
            // on Windows/Linux breaks the guest socket layer during online play (nn::socket::Connect
            // -> SendSyncRequest OutOfResource -> the game aborts). Use the JIT everywhere else.
            System.UseHypervisor.Value = OperatingSystem.IsMacOS();
